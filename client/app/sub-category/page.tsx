  ...
  return (
    <div className="p-6">
      <div className="flex flex-col md:flex-row  md:justify-between items-center mb-10 gap-3">
        ...
        <Link href="/sub-category/add"><button className="rounded-lg bg-primary px-6 py-2 cursor-pointer font-semibold text-white hover:bg-primary/90">Add New</button></Link>
      </div>
      {
            ...
            <table className="w-full">
              ...
              <tbody>
                {table.getRowModel().rows.map((row) => (
                  <tr
                    key={row.id}
                    className="bg-[#F5F5F5] my-3 h-16 rounded-lg overflow-hidden"
                  >
